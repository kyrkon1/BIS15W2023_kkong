...
(4*12)/2
```
## can click the plus C (green) and click R, can create code chunks
```{r}
2*3
```
...
x <- c(4, 6, 8, 5, 6, 7, 7, 7)
```
## variable x gets the values (4,6,8,5,6,7,7)) c means catatinate, assigning values to the letter x
