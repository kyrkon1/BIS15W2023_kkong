...
1. What are examples of different classes of objects in R?
  Numerical, Character, Integer (whole number), Logical (true or false), and Complex (formula)
  
2. What is a vector? What is the command to make a vector in R?

Representation of data, list of values of the same class 
object <- c( 1,2,3,4,5) (numerical) #catatinate
if its for a character, has to use quotations likes
new_vectors <- c("data 1", "data 2")

3. What is a data matrix and how does a data matrix relate to vectors?
multiple vectors, can create a table like an excel sheet
data matrix (2 dimensional) or stacked vectors
